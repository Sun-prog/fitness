...
class _WorkoutsListState extends State<WorkoutsList> {
  ...
  List<Workout> clearFilter() {
    ...
    final workouts = <Workout>[
      Workout('T1', "Lena", "BodySculp", "Beginner"),
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          leading: Container(
                            ...
                            child: Icon(Icons.fitness_center, color: Theme
                                .of(context)
                                .textTheme
                                .title
                                .color,),
                          ...
                          title: Text(
                            workouts[i].author, style: TextStyle(color: Theme
                              .of(context)
                              .textTheme
                              .title
                              .color, fontWeight: FontWeight.bold),),
                          trailing: Icon(
                              Icons.keyboard_arrow_right, color: Theme
                              .of(context)
                              .textTheme
                              .title
                              .color),
  ...
  Widget subtitle(BuildContext context, Workout workout) {
    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
            flex: 3,
            child: Text(workout.level, style: TextStyle(color: Theme
                .of(context)
                .textTheme
                .title
                .color))
